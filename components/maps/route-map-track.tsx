...
// TRAÇADOR DE ROTA USUÁRIO - DESTINO
...
const GOOGLE_MAPS_API_KEY = process.env.EXPO_PUBLIC_API_KEY ? process.env.EXPO_PUBLIC_API_KEY : '' // Substitua pela sua API Key
